<template>
    <seaction>
        <el-col :span="24" style="padding-bottom: 0px;margin-top: 10px">
            <el-form :inline="true">
                <el-form-item>
                    <el-select v-model="timeRange" clearable="true" placeholder="根据借阅时间段查询">
                        <el-option
        ...
        <el-table :data="borrows" highlight-current-row v-loading="listLoading" :row-class-name="tableRowClassName" style="width: 100%;">
            ...
            <el-table-column  label="借阅状态" width="100px" sortable>
                <template scope="scope">
                    ...
                    <span v-else-if="scope.row.returnId">已归还</span>
    ...
    export default {
        ...
        methods:{
            ...
            getBorrows(){
                ...
                this.$http.post("/search/searchAll",para)
                    .then(res=>{
                        let {total,rows} = res.data;
                        this.total = total;
                        this.borrows = rows;
